...
If you notice a specific Policy that is not added to the json list on the polygon_policy.sh file please let me know and i will add it to the list. Please also specify if it's a policy that should be set to true / enabled or false / disabled.
